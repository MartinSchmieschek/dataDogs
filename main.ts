...
import { PublicTransportRetriever, PublicTransportQueryPact } from '@datadogs/dogs-db';
...
async function start() {
    ...
    const allPacts = [LayoutInputPact, BloodhoundRouteQueryPact, BloodhoundIsochronePact, NearbyLandmarksPact, HueBridgeQueryPact, PublicTransportQueryPact];
